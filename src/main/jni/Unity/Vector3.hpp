...
float Vector3::Component(Vector3 a, Vector3 b) { return Dot(a, b) / Magnitude(b); }
...
float Vector3::Dot(Vector3 lhs, Vector3 rhs) { return lhs.x * rhs.x + lhs.y * rhs.y + lhs.z * rhs.z; }
...
Vector3 Vector3::LerpUnclamped(Vector3 a, Vector3 b, float t) { return (b - a) * t + a; }

float Vector3::Magnitude(Vector3 v) { return sqrt(SqrMagnitude(v)); }
...
Vector3 Vector3::Orthogonal(Vector3 v) { return v.z < v.x ? Vector3(v.y, -v.x, 0) : Vector3(0, -v.z, v.y); }
...
Vector3 Vector3::ProjectOnPlane(Vector3 vector, Vector3 planeNormal) { return Reject(vector, planeNormal); }

Vector3 Vector3::Reflect(Vector3 vector, Vector3 planeNormal) { return vector - 2 * Project(vector, planeNormal); }

Vector3 Vector3::Reject(Vector3 a, Vector3 b) { return a - Project(a, b); }
...
Vector3 Vector3::Scale(Vector3 a, Vector3 b) { return Vector3(a.x * b.x, a.y * b.y, a.z * b.z); }
...
float Vector3::SqrMagnitude(Vector3 v) { return v.x * v.x + v.y * v.y + v.z * v.z; }
