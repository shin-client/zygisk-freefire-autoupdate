...
float Vector2::Component(Vector2 a, Vector2 b) { return Dot(a, b) / Magnitude(b); }

float Vector2::Distance(Vector2 a, Vector2 b) { return Vector2::Magnitude(a - b); }

float Vector2::Dot(Vector2 lhs, Vector2 rhs) { return lhs.x * rhs.x + lhs.y * rhs.y; }
...
Vector2 Vector2::LerpUnclamped(Vector2 a, Vector2 b, float t) { return (b - a) * t + a; }

float Vector2::Magnitude(Vector2 v) { return sqrt(SqrMagnitude(v)); }
...
Vector2 Vector2::Reflect(Vector2 vector, Vector2 planeNormal) { return vector - 2 * Project(vector, planeNormal); }
...
Vector2 Vector2::Scale(Vector2 a, Vector2 b) { return Vector2(a.x * b.x, a.y * b.y); }
...
float Vector2::SqrMagnitude(Vector2 v) { return v.x * v.x + v.y * v.y; }
...
string to_string(Vector2 a) { return to_string(a.x) + std::string(", ") + to_string(a.y); }
